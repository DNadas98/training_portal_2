...
interface GroupAdminUserPreRegistrationFormProps {
...
export default function GroupAdminUserPreRegistrationForm(props: GroupAdminUserPreRegistrationFormProps) {
