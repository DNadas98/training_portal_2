...
@RestController
@RequestMapping("/api/v1/groups/{groupId}/pre-register")
@Slf4j
@RequiredArgsConstructor
public class GroupAdminPreRegistrationController {
  private final PreRegistrationService preRegistrationService;

  @GetMapping("/users/csv-template")
  public void getPreRegisterUsersCsvTemplate(
  ...
  public void preRegister(
    ...
    try {
      ...
      throw new RuntimeException("Failed to write Excel to response - " + e.getMessage());
    }
  }
}
